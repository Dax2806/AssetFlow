...
export default function AppShell({
  ...
  return (
    <>
      <div className="h-screen h-[100dvh] w-full overflow-hidden bg-slate-50 text-slate-950 dark:bg-zinc-950 dark:text-zinc-50 font-sans flex flex-col md:flex-row select-none">
