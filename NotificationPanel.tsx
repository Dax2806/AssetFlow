...
export default function UtilizationChart({ data }: UtilizationChartProps) {
  ...
  return (
    <div className="flex flex-col rounded-lg border border-slate-200 bg-white p-5 hover:shadow-sm transition-shadow dark:border-zinc-900 dark:bg-zinc-950">
      <div className="flex flex-col justify-between border-b border-slate-100 pb-3 sm:flex-row sm:items-center dark:border-zinc-900">
        <div>
        ...
        <div className="mt-2 flex items-center space-x-4 sm:mt-0">
          ...
          <div className="flex rounded-md bg-zinc-50 p-0.5 dark:bg-zinc-900">
            <button
      ...
      <div className="mt-5 h-56 w-full text-xs">
        <ResponsiveContainer width="100%" height="100%">
          <LineChart data={chartData} margin={{ top: 10, right: 10, left: -25, bottom: 5 }}>
            ...
            <CartesianGrid strokeDasharray="3 3" vertical={false} stroke="#f4f4f5" className="dark:stroke-zinc-900" />
            <XAxis
              dataKey="date"
              tickLine={false}
              axisLine={false}
            ...
            <Tooltip
              content={({ active, payload }) => {
                if (active && payload && payload.length) {
                  ...
                  return (
                    <div className="rounded border border-zinc-100 bg-white/95 p-2 shadow-xs backdrop-blur-xs dark:border-zinc-800 dark:bg-zinc-900/95">
                      ...
                      <div className="mt-1 flex items-center space-x-1">
                        ...
                        <span className="text-[10px] text-zinc-400">Utilization</span>
                      </div>
