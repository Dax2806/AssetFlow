...
const TYPE_COLORS: Record<Activity['type'], string> = {
  allocation: 'text-zinc-500 bg-zinc-50 dark:text-zinc-400 dark:bg-zinc-900',
  booking: 'text-indigo-600 bg-indigo-50 dark:text-indigo-400 dark:bg-indigo-950/30',
  maintenance: 'text-emerald-600 bg-emerald-50 dark:text-emerald-400 dark:bg-emerald-950/30',
  audit: 'text-purple-600 bg-purple-50 dark:text-purple-400 dark:bg-purple-950/30',
  transfer: 'text-amber-600 bg-amber-50 dark:text-amber-400 dark:bg-amber-950/30',
  registration: 'text-blue-600 bg-blue-50 dark:text-blue-400 dark:bg-blue-950/30'
};
      ...
      <div className="relative mt-6 flow-root">
        {activities.length === 0 ? (
          <div className="flex flex-col items-center justify-center py-12 text-center">
            ...
            <p className="mt-3 text-xs font-medium text-zinc-700 dark:text-zinc-300">No events found</p>
          ...
          <ul className="-mb-8">
            <AnimatePresence initial={false}>
              {activities.map((activity, activityIdx) => {
                ...
                const iconColorClass = TYPE_COLORS[activity.type] || 'text-zinc-500 bg-zinc-50';
                        ...
                        <div className="flex min-w-0 flex-1 justify-between space-x-4 pt-1.5">
                          <div>
                            <p className="text-xs text-zinc-600 dark:text-zinc-300">
                              ...
                              {activity.assetTag && (
                                <span className="inline-flex items-center rounded-sm bg-zinc-100 px-1 py-0.5 font-mono text-[9px] font-medium text-zinc-600 dark:bg-zinc-800 dark:text-zinc-400">
                                  {activity.assetTag}
                                </span>
                              )}
                            </p>
                            <div className="mt-1 flex items-center space-x-1.5 text-[10px] text-zinc-400 dark:text-zinc-500">
                          ...
                          <div className="whitespace-nowrap text-right text-[10px] font-medium text-zinc-400 dark:text-zinc-500">
